            ...
            <div class="box">
                <div class="box__seventh">
                    <div class="box">
                        <div class="box__half about__col">
                            <img class="price__img" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id( get_the_ID() ) ); ?>" alt="<?php the_title();?>">
                        </div>
                ...
                <div class="box__quarter">
                    <div class="contacts__info">
                        <?php if( get_field('email_contacts') ): ?>
                            <div class="contacts__info__items">
                                <h3>Email</h3>
                                <a href="mailto:<?php the_field('email_contacts')?>"><?php the_field('email_contacts')?></a>
                            </div>
                        <?php endif; ?>
                        <?php if( get_field('phone_contacts') ): $phone = str_replace([' ', '(', ')', '-'], '', get_field('phone_contacts'));?>
                            <div class="contacts__info__items">
                                <h3>Phone</h3>
                                <a href="tel:<?php echo $phone;?>"><?php the_field('phone_contacts')?></a>
                            </div>
                        <?php endif; ?>
                        <?php if( get_field('insta_url_contacts') ): ?>
                            <div class="contacts__info__items">
                                <h3>Instagram</h3>
                                <a href="<?php the_field('insta_url_contacts')?>"><?php the_field('insta_contacts')?></a>
                            </div>
                        <?php endif; ?>
                        <?php if( get_field('facebook_url_contacts') ): ?>
                            <div class="contacts__info__items">
                                <h3>Facebook</h3>
                                <a href="tel:<?php the_field('facebook_url_contacts')?>"><?php the_field('facebook_contacts')?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
