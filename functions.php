...
function kitchen_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'kitchen_custom_background_args',
			array(
...
function kitchen_scripts() {
	wp_enqueue_style( 'kitchen-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_register_script( 'jquery', get_template_directory_uri() . '/assets/js/jquery-3.6.1.min.js', array(), null, true );

    wp_enqueue_script( 'jquery' );

	wp_register_script( 'inputmask-script', get_template_directory_uri() . '/assets/js/jquery.inputmask.min.js', array(), null, true );

    wp_enqueue_script( 'inputmask-script' );
...
add_action( 'init', 'create_post_catalog' );
